            ...
            case R.id.sobot_tv_save:
                if (information != null) {
                    ...
                    if (TextUtils.isEmpty(custom_avatar)) {
                        ZCSobotApi.setChatAvatarDisplayMode(getApplicationContext(), SobotChatAvatarDisplayMode.Default, "", status4622);
                    } else {
                        ZCSobotApi.setChatAvatarDisplayMode(getApplicationContext(), SobotChatAvatarDisplayMode.ShowFixedAvatar, custom_avatar, status4622);
                    }
