...
public class SobotEvaluateActivity extends SobotDialogBaseActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    private void setViewGone() {
        ...
        if (current_model == ZhiChiConstant.client_model_robot) {
            sobot_robot_center_title.setText(initModel.getRobotName() + "" + ChatUtils.getResString(SobotEvaluateActivity.this, "sobot_question"));
            sobot_robot_relative.setVisibility(View.VISIBLE);
            ...
            sobot_robot_center_title.setText(customName + " " + ChatUtils.getResString(SobotEvaluateActivity.this, "sobot_question"));
            sobot_custom_center_title.setText(customName + " " + ChatUtils.getResString(SobotEvaluateActivity.this, "sobot_please_evaluate"));
            sobot_robot_relative.setVisibility(View.GONE);
            ...
            if (satisfactionSetBase != null) {
                ...
                if (!TextUtils.isEmpty(satisfactionSetBase.getLabelName()) && satisfactionSetBase.getIsTagMust()) {
                    if (TextUtils.isEmpty(commentParam.getProblem()) && !information.isHideManualEvaluationLabels()) {
                        ToastUtil.showToast(SobotEvaluateActivity.this, getResources().getString(R.string.sobot_the_label_is_required));//标签必选
                        return false;
                    }
                }
                ...
                if (satisfactionSetBase.getIsInputMust()) {
                    if (TextUtils.isEmpty(commentParam.getSuggest().trim())) {
                        ToastUtil.showToast(SobotEvaluateActivity.this, getResources().getString(R.string.sobot_suggestions_are_required));//建议必填
                        return false;
                    }
                }
            }
