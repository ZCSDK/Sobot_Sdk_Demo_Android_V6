...
//        return context.getResources().getString(ChatUtils.getResStringId(context, name));
    ...
    public static ZhiChiMessageBase getUploadFileModel(Context context, String tmpMsgId, File selectedFile, Information information) {
        ZhiChiMessageBase zhichiMessage = new ZhiChiMessageBase();
        ZhiChiReplyAnswer reply = new ZhiChiReplyAnswer();
    ...
    public static ZhiChiMessageBase getLocationModel(String tmpMsgId, SobotLocationModel data, Information information) {
        ZhiChiMessageBase zhichiMessage = new ZhiChiMessageBase();
        ZhiChiReplyAnswer reply = new ZhiChiReplyAnswer();
    ...
    public static ZhiChiMessageBase getUploadVideoModel(Context context, String tmpMsgId, File selectedFile, String snapshot, Information information) {
        ZhiChiMessageBase zhichiMessage = new ZhiChiMessageBase();
        ZhiChiReplyAnswer reply = new ZhiChiReplyAnswer();
        SobotCacheFile cacheFile = new SobotCacheFile();
        cacheFile.setMsgId(tmpMsgId);
...
//		sobotMsgCenterModel.setLastDateTime(Calendar.getInstance().getTime().getTime()+"");
    ...
    public static TextView initAnswerItemTextView(Context context, boolean isHistoryMsg) {
        ...
        int colorId = 0;
        if (isHistoryMsg) {
            colorId = R.color.sobot_color_suggestion_history;
        } else {
            ...
            try {
                ...
                colorId = R.color.sobot_color_link;
            }
        }
