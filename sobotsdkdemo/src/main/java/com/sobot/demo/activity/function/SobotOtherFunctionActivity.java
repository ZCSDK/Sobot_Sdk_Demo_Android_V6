        ...
        switch (v.getId()) {
            case R.id.sobot_tv_save:
                ...
                if (TextUtils.isEmpty(sobot_et_langue.getText().toString().trim())) {
                    ZCSobotApi.setInternationalLanguage(getApplicationContext(), sobot_et_langue.getText().toString().trim(), false);
                    ZCSobotApi.hideTimemsgForMessageList(getApplicationContext(), false);
                } else {
                    ZCSobotApi.setInternationalLanguage(getApplicationContext(), sobot_et_langue.getText().toString().trim(), true);
                    ZCSobotApi.hideTimemsgForMessageList(getApplicationContext(), false);
                }
